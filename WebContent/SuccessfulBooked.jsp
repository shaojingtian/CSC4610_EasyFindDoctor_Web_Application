...
<title>Successfully Booked Appointment</title>
...
<div class = "col-4">
  ...
  <div class = "col-8">
  <h4>Thank you! You have successfully scheduled an appointment with Dr. <%= session.getAttribute("docName") %> on <%= session.getAttribute("date") %> at <%= session.getAttribute("time") %>. </h4>
  </div>
 </div>
 </div>
