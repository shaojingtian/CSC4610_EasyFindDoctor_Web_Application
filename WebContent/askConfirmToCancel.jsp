...
<div class = "col-8">
<h3>Do you want to cancel the appointment with Dr. <%= session.getAttribute("cancelDocName") %> on <%= session.getAttribute("cancelDate") %> at <%= session.getAttribute("cancelTime") %>? </h3>
<br>
    <br>
    <br>
    <br>
  <form action="http://54.164.36.159/EasyFindDoctors/CancelAppointment" method="post">
    ...
    <br> 
  <form action="http://54.164.36.159/EasyFindDoctors/GetAppointments" method="post">
    <button type="submit", class = "btn btn-secondary">No, I haven't decided yet</button>
  </form>
  </div> 
  </div>
  </div>
