...
<a href="Login.jsp"><img src="logo.jpg" width="300" alt="Easy Find Doctors Logo"></a> 
  ...
  <div class="container">
  <h2>Sign in to Easy Find Doctors</h2>
  <br>
  <form action="http://54.164.36.159/EasyFindDoctors/Login" method="post">
  ...
  <br>
  <p>New to Easy Find Doctors?</p><a href="Register.jsp">CREATE ACCOUNT</a> 
  </div>
