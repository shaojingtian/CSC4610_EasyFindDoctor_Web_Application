...
<div class = "col-4">
  ...
  <form action="http://54.164.36.159/EasyFindDoctors/GoToHomePage" method="post">
    <button type="submit", class = "btn btn-info">Find a doctor</button>
  </form>
    <br>
    <br> 
    <br> 
...
<div class = "col-4">
  ...
  <p>Email Address: <%= session.getAttribute("userEmail") %></p>
  <p>Mailing Address: <%= session.getAttribute("userAddress") %></p>
  <br>
  <h3>Basic Information:</h3>
  <p>Date of Birth: <%= session.getAttribute("userDob") %></p>
  <p>Gender: <%= session.getAttribute("userGender") %></p>
